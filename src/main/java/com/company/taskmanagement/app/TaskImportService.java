...
public class TaskImportService {
    ...
    public int importTasks(){
        List<String> externalTasksNames = obtainExternalTasksNames();
    ...
    private List<String> obtainExternalTasksNames() {
    ...
    private Project loadDefaultProject(){
        Optional<Project> entity = dataManager.load(Project.class)
                .query("select proj from tm_Project proj where proj.defaultProject = :defaultProject")
